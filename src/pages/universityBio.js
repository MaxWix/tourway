      ...
      />
        ...
        <div className="universityBioContent">
          ...
          <div className="overviewIMGs">
            <img src={DrexelOverview1} alt="Photograph of exterior of Rush Student Center"/>
            <img src={DrexelOverview2} alt="interior of the URBN Center's stairs, and exposed beaming"/>
          </div>
          <h3>Financial Aid</h3>
