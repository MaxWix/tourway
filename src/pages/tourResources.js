...
const TourResources = () => {
  ...
  return (
    <div className="TourResources">
      <Header HeaderIMG={blueBG} height="150px" swoopTop="48px" />
      ...
      <div className="mainContent mainContentResources">
        ...
        <div className="resourcesContainer">
          <Resources icon={<img src={FAQIcon} alt="FAQ Icon" />} text="FAQ" />
          <Resources
          ...
          <Resources
            icon={
              <img
                src={ApplicationReqIcon}
                alt="Application Requirements Icon"
              />
            }
